...
export const AdminUsersRoute = () => {
    ...
    const { data: response, isLoading, error } = useGetAdminUsersList({ page, page_size: pageSize });
    ...
    const handleToggleActive = async (userId: string, currentStatus: boolean) => {
        try {
            ...
            await queryClient.invalidateQueries({ queryKey: getGetAdminUsersListQueryKey() });
            toast({
                title: "Success",
            ...
            toast({
                variant: "destructive",
                title: "Error",
                description: e.response?.data?.message || "Failed to update user status",
            });
        }
    };
                                ...
                                <TableCell>
                                    <DropdownMenu>
                                        ...
                                        <DropdownMenuContent align="end">
                                            ...
                                            <DropdownMenuItem onClick={() => navigate(`/dashboard/admin/users/${user.id}/edit`)}>

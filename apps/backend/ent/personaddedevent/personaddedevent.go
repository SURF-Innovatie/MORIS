...
const (
	// Label holds the string label denoting the personaddedevent type in the database.
	...
	Table = "person_added_events"
	// EventTable is the table that holds the event relation/edge.
	EventTable = "person_added_events"
	// EventInverseTable is the table name for the Event entity.
	// It exists in this package in order to avoid circular dependency with the "event" package.
	EventInverseTable = "events"
	// EventColumn is the table column denoting the event relation/edge.
	EventColumn = "event_person_added"
)

// Columns holds all SQL columns for personaddedevent fields.
var Columns = []string{
	FieldID,
	FieldPersonID,
}
...
// OrderOption defines the ordering options for the PersonAddedEvent queries.

...
var (
	...
	ProductsColumns = []*schema.Column{
		...
		{Name: "doi", Type: field.TypeString, Unique: true, Nullable: true},
	...
	// ProductAuthorsColumns holds the columns for the "product_authors" table.
	ProductAuthorsColumns = []*schema.Column{
		{Name: "product_id", Type: field.TypeUUID},
		{Name: "person_id", Type: field.TypeUUID},
	}
	// ProductAuthorsTable holds the schema information for the "product_authors" table.
	ProductAuthorsTable = &schema.Table{
		Name:       "product_authors",
		Columns:    ProductAuthorsColumns,
		PrimaryKey: []*schema.Column{ProductAuthorsColumns[0], ProductAuthorsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "product_authors_product_id",
				Columns:    []*schema.Column{ProductAuthorsColumns[0]},
				RefColumns: []*schema.Column{ProductsColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "product_authors_person_id",
				Columns:    []*schema.Column{ProductAuthorsColumns[1]},
				RefColumns: []*schema.Column{PersonsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
...
func init() {
	...
	ProductAuthorsTable.ForeignKeys[0].RefTable = ProductsTable
	ProductAuthorsTable.ForeignKeys[1].RefTable = PersonsTable
}

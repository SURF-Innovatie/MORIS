...
type Repository interface {
	...
	CreateNode(ctx context.Context, name string, parentID *uuid.UUID) (*entities.OrganisationNode, error)
	GetNode(ctx context.Context, id uuid.UUID) (*entities.OrganisationNode, error)
	UpdateNode(ctx context.Context, id uuid.UUID, name string, parentID *uuid.UUID) (*entities.OrganisationNode, error)

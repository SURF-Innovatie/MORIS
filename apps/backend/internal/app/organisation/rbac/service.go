...
func (s *service) HasPermission(ctx context.Context, personID uuid.UUID, nodeID uuid.UUID, permission entities.Permission) (bool, error) {
	return s.repo.HasPermission(ctx, personID, nodeID, permission)
}

func (s *service) GetMyPermissions(ctx context.Context, userID, nodeID uuid.UUID) ([]entities.Permission, error) {

...
func (e CustomFieldValueSet) Apply(p *entities.Project) {
...
// Decider
func DecideCustomFieldValueSet(ctx context.Context, projectID, userID uuid.UUID, state *entities.Project, cmd CustomFieldValueSetInput, status Status) (Event, error) {
	if state == nil {

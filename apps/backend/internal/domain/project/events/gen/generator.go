...
func generateFieldEvents(events []FieldEvent) error {
	...
	RegisterDecider[%s](%s,
		func(ctx context.Context, projectID uuid.UUID, actor uuid.UUID, cur *projdomain.Project, in %s, status Status) (Event, error) {
...
func generateEntityCollectionEvents(events []EntityCollectionEvent) error {
	...
	RegisterDecider[%sAddedInput](%sAddedType,
		func(ctx context.Context, projectID uuid.UUID, actor uuid.UUID, cur *projdomain.Project, in %sAddedInput, status Status) (Event, error) {
	...
	RegisterDecider[%sRemovedInput](%sRemovedType,
		func(ctx context.Context, projectID uuid.UUID, actor uuid.UUID, cur *projdomain.Project, in %sRemovedInput, status Status) (Event, error) {
...
func (e *{{eventName .Type}}) Apply(project *projdomain.Project) {
...
func (e *{{.Entity}}Added) Apply(project *projdomain.Project) {
...
func (e *{{.Entity}}Removed) Apply(project *projdomain.Project) {

...
func (e *StartDateChanged) Apply(project *project.Project) {
...
func init() {
	...
	RegisterDecider[StartDateChangedInput](StartDateChangedType,
		func(ctx context.Context, projectID uuid.UUID, actor uuid.UUID, cur *project.Project, in StartDateChangedInput, status Status) (Event, error) {

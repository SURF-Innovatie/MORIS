...
func (e *DescriptionChanged) Apply(project *project.Project) {
...
func init() {
	...
	RegisterDecider[DescriptionChangedInput](DescriptionChangedType,
		func(ctx context.Context, projectID uuid.UUID, actor uuid.UUID, cur *project.Project, in DescriptionChangedInput, status Status) (Event, error) {

...
func (e *TitleChanged) Apply(project *project.Project) {
...
func init() {
	...
	RegisterDecider[TitleChangedInput](TitleChangedType,
		func(ctx context.Context, projectID uuid.UUID, actor uuid.UUID, cur *project.Project, in TitleChangedInput, status Status) (Event, error) {
